...
from .TwitchPlays_Connection import *
...
class TwitchGECController(QThread):
    def __init__(self,mainWindowSignal,config:configparser.ConfigParser):
        ...
        self.TWITCH_CHANNEL = config.get("TWITCH INTEGRATION","channel")
        self.allowedMods = config.get("TWITCH INTEGRATION","mods").lower().replace(" ","").split(",")
        print(self.allowedMods)
        self.MESSAGE_RATE = config.getfloat("TWITCH INTEGRATION","message_rate")#0.5
        self.MAX_QUEUE_LENGTH = config.getint("TWITCH INTEGRATION","queue_length")#= 10
        self.MAX_WORKERS = config.getint("TWITCH INTEGRATION","workers")#5 # Maximum number of threads you can process at a time
        self.CMD_ADD_TRAINER=config.get("TWITCH INTEGRATION","CMD_ADD_TRAINER")
        self.CMD_REMOVE_TRAINER=config.get("TWITCH INTEGRATION","CMD_REMOVE_TRAINER")
        self.CMD_ADD_ITEM=config.get("TWITCH INTEGRATION","CMD_ADD_ITEM")
        self.CMD_REMOVE_ITEM=config.get("TWITCH INTEGRATION","CMD_REMOVE_ITEM")
        self.CMD_ADD_MISC=config.get("TWITCH INTEGRATION","CMD_ADD_MISC")
        self.CMD_REMOVE_MISC=config.get("TWITCH INTEGRATION","CMD_REMOVE_MISC")
        self.CMD_ADD_MOVE=config.get("TWITCH INTEGRATION","CMD_ADD_MOVE")
        self.CMD_REMOVE_MOVE=config.get("TWITCH INTEGRATION","CMD_REMOVE_MOVE")
        self.CMD_ADD_POKEMON=config.get("TWITCH INTEGRATION","CMD_ADD_POKEMON")
        self.CMD_ADD_POKEMON_BLUE=config.get("TWITCH INTEGRATION","CMD_ADD_POKEMON_BLUE")
        self.CMD_REMOVE_POKEMON=config.get("TWITCH INTEGRATION","CMD_REMOVE_POKEMON")
        self.BACKUP_COUNTER=config.getint("TWITCH INTEGRATION","BACKUP_COUNTER")        
        self.save=False
